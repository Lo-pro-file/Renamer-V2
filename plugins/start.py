	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      ...
                                      [InlineKeyboardButton("🦋 Mirror Group 🦋", url="https://t.me/+WbrBWHgFCKw0YzQ1")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/WOODcraft_Mirror_Topic'),
                                      InlineKeyboardButton("Follow Rules", url='https://t.me/Opleech/13')],
...
async def send_doc(client, message):
    ...
    if update_channel:
        try:
            ...
            await client.send_message(log_channel,f"🦋 #Rename_pro_v1 🦋,\n\n**ID** : `{user_id}`\n**Name**: {message.from_user.first_name} {message.from_user.last_name}\n**User-Plan** : {user}\n\n ",
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact Farooq 🦋", url='https://t.me/Farooq_is_KING')],
                                                                     [InlineKeyboardButton("🔺 Leech Group 🔺", url='https://t.me/+WbrBWHgFCKw0YzQ1')],
                                                                     [InlineKeyboardButton("🦋 Update Channel  ", url='https://t.me/Opleech'),
                                                                     InlineKeyboardButton("🦋 Support Group 🦋", url='https://t.me/WOODcraft_Mirror_Topic')],
                                                                     [InlineKeyboardButton("LIMIT", url='https://t.me/Opleech/21')]
                                                                    ]))
